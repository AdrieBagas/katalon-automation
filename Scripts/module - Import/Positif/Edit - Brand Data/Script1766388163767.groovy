...
WebUI.setText(findTestObject('Object - Import/Textbox - Dynamic Editable Textbox', [('col_name') : 'Name']), 'Brand 1')
...
WebUI.setText(findTestObject('Object - Import/Textbox - Dynamic Editable Textbox', [('col_name') : 'Model/Type']), 'Barang1, Barang 2')
