...
WebUI.setText(findTestObject('Object - Import/Textbox - Dynamic Editable Textbox', [('col_name') : 'Purchase Date']), 'asdm')

WebUI.click(findTestObject('Object - Import/Button - Save'))

WebUI.verifyElementVisible(findTestObject('Object - Import/Validator Message - Must be a valid date'), FailureHandling.STOP_ON_FAILURE)
