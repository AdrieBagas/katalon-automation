...
WebUI.setText(findTestObject('Object - Import/Textbox - Dynamic Editable Textbox', [('col_name') : 'Purchase Cost']), '0')

WebUI.click(findTestObject('Object - Import/Button - Save'))

WebUI.verifyElementVisible(findTestObject('Object - Import/Validator Message - Must be greater than'))
