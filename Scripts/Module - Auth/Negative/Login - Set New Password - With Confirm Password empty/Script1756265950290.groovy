...
WebUI.setText(findTestObject('Object Repository/New Folder/input - konfirmasi password'), '')

WebUI.click(findTestObject('Object Repository/New Folder/button - save new password'))

WebUI.verifyElementVisible(findTestObject('login session object/Validator Message - Confirm Password empty'))
