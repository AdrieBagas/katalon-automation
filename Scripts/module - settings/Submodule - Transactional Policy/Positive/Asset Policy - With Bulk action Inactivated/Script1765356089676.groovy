...
WebUI.uncheck(findTestObject('Object - Transactional Policy/Switch - Bulk Policy Borrow'))

WebUI.verifyElementNotChecked(findTestObject('Object - Transactional Policy/Switch - Bulk Policy Self Service'), 2)

WebUI.verifyElementHasAttribute(findTestObject('Object - Transactional Policy/Switch - Bulk Policy Self Service'), 'disabled', 
    2)

WebUI.uncheck(findTestObject('Object - Transactional Policy/Switch - Bulk Policy Assign'))

WebUI.uncheck(findTestObject('Object - Transactional Policy/Switch - Bulk Policy Transfer'))
