...
WebUI.uncheck(findTestObject('Object - Transactional Policy/Switch - Assign policy'))

WebUI.verifyElementText(findTestObject('Object - Assets/Toast - Success'), 'Success, asset transactional policy has been updated.')

CustomKeywords.'company.SimpleLogValidator.verifyLog'('Edit', 'Asset QR', 'Assign (Active)', 'Assign (Inactive)')
