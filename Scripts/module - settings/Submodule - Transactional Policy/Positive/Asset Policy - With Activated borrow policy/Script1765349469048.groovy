...
WebUI.check(findTestObject('Object - Transactional Policy/Switch - Borrow policy'))

WebUI.verifyElementText(findTestObject('Object - Assets/Toast - Success'), 'Success, asset transactional policy has been updated.')

CustomKeywords.'company.SimpleLogValidator.verifyLog'('Edit', 'Asset QR', 'Borrow (Inactive)', 'Borrow (Active)')
