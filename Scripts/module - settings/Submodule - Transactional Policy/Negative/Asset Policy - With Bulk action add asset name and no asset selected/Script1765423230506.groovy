...
WebUI.click(findTestObject('Object - Transactional Policy/Button - Select'))

WebUI.verifyElementVisible(findTestObject('Object - Transactional Policy/Validator Message - Asset name empty'))
