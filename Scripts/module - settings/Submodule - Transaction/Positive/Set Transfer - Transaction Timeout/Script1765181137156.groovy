...
WebUI.setText(findTestObject('object - transaction/Input - Transaction Timeout'), '5')
...
CustomKeywords.'company.SimpleLogValidator.verifyLog'('Edit', 'Transaction Timeout', value + 'Hour(s)', editedTime + 'Hour(s)', 
    0)
