...
WebUI.setText(findTestObject('Object - User/Input - Last Name'), 'Non login')
...
WebUI.verifyElementText(findTestObject('Object - User/Input - First Name'), '')

WebUI.verifyElementText(findTestObject('Object - User/Input - Last Name'), '')

WebUI.verifyElementVisible(findTestObject('Object - User/Select - Division'))

WebUI.verifyElementVisible(findTestObject('Object - User/Select - Position'))

WebUI.verifyElementText(findTestObject('Object - User/Input - Employee ID'), '')
