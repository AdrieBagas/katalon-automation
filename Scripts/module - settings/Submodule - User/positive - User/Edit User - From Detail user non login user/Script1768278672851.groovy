...
WebUI.click(findTestObject('Object - User/Button - Action'))

WebUI.click(findTestObject('Object - User/Action - Edit'))

WebUI.click(findTestObject('Object - User/Button - Clear Field'))
...
WebUI.setText(findTestObject('Object - User/Input - First Name'), 'Edited')

WebUI.setText(findTestObject('Object - User/Input - Last Name'), 'User')

WebUI.click(findTestObject('Object - User/Select - Position'))

WebUI.click(findTestObject('Object - User/List - Default Position'))

WebUI.click(findTestObject('Object - User/Select - Division'))

WebUI.click(findTestObject('Object - User/List - Default Division'))

WebUI.setText(findTestObject('Object - User/Input - Employee ID'), GlobalVariable.generatedCodeName)

WebUI.setText(findTestObject('Object - User/Input - Phone Number'), '88182887111')

WebUI.click(findTestObject('Object - User/Button - Save'))

WebUI.click(findTestObject('Object - User/Button - Continue'))

WebUI.waitForElementVisible(findTestObject('Object - User/Toast - Success'), 1)

WebUI.verifyElementText(findTestObject('Object - User/Toast - Success'), 'Success, user has been edited.')
