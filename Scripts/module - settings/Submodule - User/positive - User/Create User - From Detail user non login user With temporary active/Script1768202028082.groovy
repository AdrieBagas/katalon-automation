...
WebUI.setText(findTestObject('Object - User/Input - Last Name'), 'Temporary User')
...
WebUI.setText(findTestObject('Object - User/Input - Phone Number'), '88182887222')

WebUI.check(findTestObject('Object - User/Checkbox - Temporary user'))

WebUI.click(findTestObject('Object - User/Input - Date'))

WebUI.click(findTestObject('Object - User/List - Date Day'))
...
CustomKeywords.'company.SimpleLogValidator.verifyLog'('Create', 'Name', '-', 'Default Temporary User', 0)
