...
WebUI.click(findTestObject('Object - Settings - Role/Button - Delete All Approver Level 1'))
...
WebUI.verifyElementText(findTestObject('Object - Settings - Role/Toast - Success'), 'Success, level 1 approver has been removed.')
