...
WebUI.uncheck(findTestObject('Object - Settings - Role/Checkbox - Permission Edit in Detail System Role', [('userName') : GlobalVariable.defaultUserName]))
...
CustomKeywords.'company.SimpleLogValidator.verifyLog'('Edit', 'Edit', 'Active', 'Inactive', 0)
