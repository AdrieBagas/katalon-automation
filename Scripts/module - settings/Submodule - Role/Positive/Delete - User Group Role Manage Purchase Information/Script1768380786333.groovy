...
WebUI.click(findTestObject('Object - Settings - Role/Button - Remove From Elipsis'))
...
CustomKeywords.'company.SimpleLogValidator.verifyLog'('Remove', 'Name', GlobalVariable.defaultUserName, '-', 0)
