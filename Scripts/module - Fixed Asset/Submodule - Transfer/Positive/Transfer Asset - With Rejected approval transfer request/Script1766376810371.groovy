...
WebUI.doubleClick(findTestObject('Object - Transfer/Switch - Approval'))

WebUI.setText(findTestObject('Object - Transfer/Input - Note'), 'ditolak')
...
CustomKeywords.'company.UrlValidator.verifyUrl'('/assets/transfer/history')
