...
WebUI.check(findTestObject('Object - Assignment/Checkbox - Asset to Assign confirmation'))

WebUI.click(findTestObject('Object - Borrow/Button - Confirm'))

WebUI.click(findTestObject('Object - Borrow/Button - Continue'))

WebUI.verifyElementText(findTestObject('Object - Borrow/Toast - Success'), 'Success, handover asset has been confirmed.')
...
WebUI.click(findTestObject('Object - Assignment/Button - Handover'))
