...
WebUI.click(findTestObject('Object - Available/List - Asset QR'))
...
WebUI.click(findTestObject('Object - Available/Button - Scan QR'))
...
CustomKeywords.'company.AssetListValidator.verifyAssetRow'('Default QR', 'QR', [('brand.name') : 'Default Brand', ('model.name') : 'Default Model'
        , ('group.name') : 'Default Group', ('category.name') : 'Default Category'], 0, true)

WebUI.click(findTestObject('Object - Available/Button - Changelog'))

CustomKeywords.'company.SimpleLogValidator.verifyLog'('Create', '-', '-', 'Default QR', 0)
