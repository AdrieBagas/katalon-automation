...
CustomKeywords.'company.AssetListValidator.verifyAssetRow'('Default RFID', 'RFID', [('brand.name') : 'Default Brand', ('model.name') : 'Default Model'
        , ('group.name') : 'Default Group', ('category.name') : 'Default Category', ('status') : 'Not Paired Yet'], 0, false)

WebUI.click(findTestObject('Object - Available/Button - Changelog'))

CustomKeywords.'company.SimpleLogValidator.verifyLog'('Create', '-', '-', 'Default Asset RFID', 0)
