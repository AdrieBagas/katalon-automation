...
CustomKeywords.'company.UrlValidator.verifyUrl'('/assets/all')

WebUI.click(findTestObject('Object - Available/Button - Register'))

CustomKeywords.'company.UrlValidator.verifyUrl'('/assets/all/register-asset')
...
WebUI.click(findTestObject('Object - Available/List - Asset Name'))
...
CustomKeywords.'company.AssetListValidator.verifyAssetRow'('Default Asset', 'Non-Tag', [('brand.name') : 'Default Brand'
        , ('model.name') : 'Default Model', ('group.name') : 'Default Group', ('category.name') : 'Default Category', ('status') : 'available'], 
    0, false)

WebUI.click(findTestObject('Object - Available/Button - Changelog'))

CustomKeywords.'company.SimpleLogValidator.verifyLog'('Create', '-', '-', 'Default Asset', 0)
