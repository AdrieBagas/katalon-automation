...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Selection value 1'), GlobalVariable.generatedOver30Name)

WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Selection value 2'), GlobalVariable.generatedOver60Name)
...
WebUI.verifyElementVisible(findTestObject('Object - Maintenance Routine/Validator Message - Maks 30. character'))
