...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Task Name'), '')
...
WebUI.verifyElementVisible(findTestObject('Object - Maintenance Routine/Validator Message - Name empty'))
