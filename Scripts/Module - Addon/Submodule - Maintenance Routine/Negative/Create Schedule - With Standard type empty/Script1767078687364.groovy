...
WebUI.click(findTestObject('Object - Maintenance Routine/Checkbox - Have standard value'))
...
WebUI.verifyElementVisible(findTestObject('Object - Maintenance Routine/Validator Message - Standard type empty'))
