...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Duration'), '')
...
WebUI.verifyElementVisible(findTestObject('Object - Maintenance Routine/Validator Message - Duration empty'))
