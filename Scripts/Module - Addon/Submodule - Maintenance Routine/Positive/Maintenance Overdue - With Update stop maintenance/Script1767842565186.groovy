...
WebUI.click(findTestObject('Object - Maintenance Routine/List - Stop Maintenance'))
...
WebUI.verifyElementText(findTestObject('Object - Maintenance Routine/Toast - Success'), 'Success, maintenance task has been updated.')

WebUI.click(findTestObject('Object - Maintenance Routine/Tab - history'))

CustomKeywords.'company.AssetListValidator.verifySpecificRowData'([('status') : 'Stopped'], 0)
