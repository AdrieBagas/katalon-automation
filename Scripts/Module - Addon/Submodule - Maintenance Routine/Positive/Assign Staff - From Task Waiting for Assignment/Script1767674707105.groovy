...
WebUI.click(findTestObject('Object - Maintenance Routine/Action - Assign Staff'))
...
WebUI.verifyElementVisible(findTestObject('Object - Maintenance Routine/Badge - User Staff'))
