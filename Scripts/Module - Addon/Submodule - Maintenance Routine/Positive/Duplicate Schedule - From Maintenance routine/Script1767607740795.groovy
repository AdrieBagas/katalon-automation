...
WebUI.click(findTestObject('Object - Maintenance Routine/Action - Duplicate'))

WebUI.verifyElementAttributeValue(findTestObject('Object - Maintenance Routine/Input - Task Name'), 'value', 'Default Maintenance (2)', 
    1)
...
CustomKeywords.'company.AssetListValidator.verifySpecificRowData'([('status') : 'On Schedule', ('taskName') : 'Default Maintenance (2)'], 
    0)
