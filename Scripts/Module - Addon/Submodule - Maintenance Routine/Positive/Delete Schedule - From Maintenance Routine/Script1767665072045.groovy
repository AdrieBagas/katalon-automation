...
WebUI.click(findTestObject('Object - Maintenance Routine/Action - Delete'))

WebUI.click(findTestObject('Object - Maintenance Routine/Button - Delete'))

WebUI.verifyElementText(findTestObject('Object - Maintenance Routine/Toast - Success'), 'Success, schedule has been deleted.')
