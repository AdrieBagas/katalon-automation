...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Template Name'), 'Testing Template Selection')
...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Template Description'), GlobalVariable.generatedOver120Name)
...
WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Measurement'), 'Condition')

WebUI.click(findTestObject('Object - Maintenance Routine/Button - Add Selection'))

WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Selection value 1'), 'Good')

WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Selection value 2'), 'Need Repair')

WebUI.setText(findTestObject('Object - Maintenance Routine/Input - Selection value 3'), 'Broken')
...
CustomKeywords.'company.validatorMessage.verifyErrorMessage'('Max. 120 characters')

WebUI.click(findTestObject('Object - Maintenance Routine/Button - Close'))

WebUI.click(findTestObject('Object - Maintenance Routine/Button - Continue'))
