...
WebUI.click(findTestObject('Object - Audit/Button - Select Group in List', [('groupName') : 'AudAdit']))
...
WebUI.verifyElementVisible(findTestObject('Object - Audit/Toast - Error'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object - Audit/Toast - Error'), 'Error, the asset is not in this audit list.')
