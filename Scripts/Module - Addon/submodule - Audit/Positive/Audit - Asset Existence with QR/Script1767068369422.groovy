...
WebUI.waitForElementNotVisible(findTestObject('Object - Audit/Toast - QR Scanning'), 5)
...
WebUI.verifyElementVisible(findTestObject('Object - Audit/Verify - Event Log', [('action') : 'Start Audit']), FailureHandling.STOP_ON_FAILURE)
