...
WebUI.click(findTestObject('Object - Audit/Button - Cancel Audit'))
...
WebUI.verifyElementText(findTestObject('Object - Audit/Toast - Success'), 'Success, audit task has been canceled.')
