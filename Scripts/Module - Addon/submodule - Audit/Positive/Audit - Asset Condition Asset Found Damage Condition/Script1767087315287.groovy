...
WebUI.click(findTestObject('Object - Audit/Button - Select Group in List', [('groupName') : 'testes']))
...
WebUI.click(findTestObject('Object - Audit/List - Dropdown Asset found, damaged condition'))

WebUI.uploadFile(findTestObject('Object - Audit/Input - Image Asset Damage'), GlobalVariable.imagePath)

WebUI.click(findTestObject('Object - Audit/Button - Apply Image'))
