...
WebUI.click(findTestObject('Object - Audit/List - Elipsis Report Missing'))

WebUI.setText(findTestObject('Object - Audit/Input - Note'), GlobalVariable.generatedOver60Name)
