...
CustomKeywords.'company.CustomKeyword.loginToApp'(GlobalVariable.EmailStaff, GlobalVariable.Password)
...
WebUI.verifyElementNotVisible(findTestObject('Object - Audit/List - Elipsis Edit Condition'))
