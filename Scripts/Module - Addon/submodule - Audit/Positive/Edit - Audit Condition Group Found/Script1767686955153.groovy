...
WebUI.click(findTestObject('Object - Audit/Button - Edit Group Found'))

WebUI.click(findTestObject('Object - Audit/Button - Select Group in List', [('groupName') : 'Test Role']))
